...
export interface ProjectRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, AddressLike, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
...
export namespace ProjectMetaUpdatedEvent {
  export type InputTuple = [
    id: BigNumberish,
    metaHash: BytesLike,
    treasury: AddressLike,
...
export interface ProjectRegistry extends BaseContract {
  ...
  projects: TypedContractMethod<
    [arg0: BigNumberish],
    [
      [bigint, string, bigint, string, bigint, string, bigint, boolean] & {
        id: bigint;
        name: string;
        entityType: bigint;
        treasury: string;
  ...
  setActive: TypedContractMethod<
    [id: BigNumberish, active: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getEvent(
    key: "ProjectMetaUpdated"
  ): TypedContractEvent<
    ProjectMetaUpdatedEvent.InputTuple,
    ProjectMetaUpdatedEvent.OutputTuple,
    ProjectMetaUpdatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "ProjectCreated(uint256,string,uint8,address,uint256,bytes32)": TypedContractEvent<
      ProjectCreatedEvent.InputTuple,
      ProjectCreatedEvent.OutputTuple,
      ProjectCreatedEvent.OutputObject
    >;
    ...
    "ProjectMetaUpdated(uint256,bytes32,address,uint256)": TypedContractEvent<
      ProjectMetaUpdatedEvent.InputTuple,
      ProjectMetaUpdatedEvent.OutputTuple,
      ProjectMetaUpdatedEvent.OutputObject
    >;
    ProjectMetaUpdated: TypedContractEvent<
      ProjectMetaUpdatedEvent.InputTuple,
      ProjectMetaUpdatedEvent.OutputTuple,
      ProjectMetaUpdatedEvent.OutputObject
    >;

    "ProjectStatusChanged(uint256,bool)": TypedContractEvent<
      ProjectStatusChangedEvent.InputTuple,
      ProjectStatusChangedEvent.OutputTuple,
      ProjectStatusChangedEvent.OutputObject
    >;
