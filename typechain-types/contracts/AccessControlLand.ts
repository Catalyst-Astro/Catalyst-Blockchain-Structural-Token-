...
export interface AccessControlLandInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "VALIDATOR_ROLE"
...
export interface AccessControlLand extends BaseContract {
  connect(runner?: ContractRunner | null): AccessControlLand;
  waitForDeployment(): Promise<this>;

  interface: AccessControlLandInterface;
