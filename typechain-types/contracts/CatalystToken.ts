...
export interface CatalystTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "annualInflationRate"
  ...
  encodeFunctionData(
    functionFragment: "annualInflationRate",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CatalystToken extends BaseContract {
  connect(runner?: ContractRunner | null): CatalystToken;
  waitForDeployment(): Promise<this>;

  interface: CatalystTokenInterface;
  ...
  annualInflationRate: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "annualInflationRate"
